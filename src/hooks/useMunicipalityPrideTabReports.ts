    ...
    const fetchMunicipalityPrideReports = async () => {
        ...
        try {
            const [
                ...
                axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/entered-municipality-chart/'),
                axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/submitted-budget-chart/'),

                axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/entered-municipality/report/?type=excel'),
                axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/submitted-budget/report/?type=excel'),

                axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/entered-municipality/report/?type=pdf'),
                axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/submitted-budget/report/?type=pdf'),
            ]);
    ...
    const downloadFile = async (endpoint: string, type: 'pdf' | 'excel', filename: string) => {
        ...
        try {
            const response = await axios.get(
                `https://www.bardagoriyapms.com/api/planning/municipality-pride-project/${endpoint}/report/?type=${type}`,
