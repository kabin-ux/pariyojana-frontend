    ...
    const fetchBudgetReports = async () => {
        ...
        try {
            const [
                ...
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipalitylevel-chart/'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/federalgov-chart/'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipalitypride-chart/'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/provinciallytransfer-chart/'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/thematiccommittee-chart/'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/wardlevel-chart/'),

                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipalitylevel/report/?type=excel'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/federalgov/report/?type=excel'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipalitypride/report/?type=excel'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/provinciallytransfer/report/?type=excel'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/thematiccommittee/report/?type=excel'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/wardlevel/report/?type=excel'),

                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipalitylevel/report/?type=pdf'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/federalgov/report/?type=pdf'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipalitypride/report/?type=pdf'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/provinciallytransfer/report/?type=pdf'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/thematiccommittee/report/?type=pdf'),
                axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/wardlevel/report/?type=pdf'),
            ]);
    ...
    const downloadFile = async (endpoint: string, type: 'pdf' | 'excel', filename: string) => {
        ...
        try {
            const response = await axios.get(
                `https://www.bardagoriyapms.com/api/planning/budget-committee/${endpoint}/report/?type=${type}`,
