    ...
    const fetchWardReports = async () => {
        ...
        try {
            const [
                ...
                axios.get('http://13.233.254.0/api/planning/ward-office/wardlevel-chart/'),
                axios.get('http://13.233.254.0/api/planning/ward-office/wardlevelthemtic-chart/'),
                axios.get('http://13.233.254.0/api/planning/ward-office/municipalitylevel-chart/'),
                axios.get('http://13.233.254.0/api/planning/ward-office/prioritizedward-chart/'),
                axios.get('http://13.233.254.0/api/planning/ward-office/prioritizedwardthematic-chart/'),

                axios.get('http://13.233.254.0/api/planning/ward-office/ward-level/report/?type=excel', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/ward-thematic/report/?type=excel', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/municipality/report/?type=excel', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/prioritized-ward/report/?type=excel', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/prioritized-wardthematic/report/?type=excel', { responseType: 'blob' }),

                axios.get('http://13.233.254.0/api/planning/ward-office/ward-level/report/?type=pdf', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/ward-thematic/report/?type=pdf', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/municipality/report/?type=pdf', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/prioritized-ward/report/?type=pdf', { responseType: 'blob' }),
                axios.get('http://13.233.254.0/api/planning/ward-office/prioritized-wardthematic/report/?type=pdf', { responseType: 'blob' }),
            ]);
    ...
    const downloadFile = async (endpoint: string, type: 'pdf' | 'excel', filename: string) => {
        ...
        try {
            const response = await axios.get(
                `http://13.233.254.0/api/planning/ward-office/${endpoint}/report/?type=${type}`,
