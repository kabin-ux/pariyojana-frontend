    ...
    const fetchCityCouncilReports = async () => {
        ...
        try {
            const [
                ...
                axios.get('http://213.199.53.33/api/planning/municipal-assembly/submittedproject-chart/'),
                axios.get('http://213.199.53.33/api/planning/municipal-assembly/projectapprove-chart/'),

                axios.get('http://213.199.53.33/api/planning/municipal-assembly/submittedproject/report/?type=excel', {
                    responseType: 'blob'
                }),
                axios.get('http://213.199.53.33/api/planning/municipal-assembly/projectapprove/report/?type=excel', {
                    responseType: 'blob'
                }),

                axios.get('http://213.199.53.33/api/planning/municipal-assembly/submittedproject/report/?type=pdf', {
                    responseType: 'blob'
                }),
                axios.get('http://213.199.53.33/api/planning/municipal-assembly/projectapprove/report/?type=pdf', {
                    responseType: 'blob'
                })
            ]);
    ...
    const downloadFile = async (endpoint: string, type: 'pdf' | 'excel', filename: string) => {
        ...
        try {
            const response = await axios.get(
                `http://213.199.53.33/api/planning/municipal-assembly/${endpoint}/report/?type=${type}`,
