...
export const useInstallmentDetails = (projectId: number) => {
    ...
    const fetchBanks = async () => {
        try {
            ...
            const res = await axios.get(`http://www.bardagoriyapms.com/api/settings/bank`);
            setBanks(res.data);
        } catch (err) {
    ...
    const fetchFirst = async () => {
        try {
            setFirstLoading(true);
            const res = await axios.get(`http://www.bardagoriyapms.com/api/projects/first-installment/${projectId}/`);
    ...
    const fetchSecond = async () => {
        try {
            ...
            const res = await axios.get(`http://www.bardagoriyapms.com/api/projects/second-installment/${projectId}/`);
    ...
    const fetchThird = async () => {
        try {
            ...
            const res = await axios.get(`http://www.bardagoriyapms.com/api/projects/third-installment/${projectId}/`);
    ...
    const fetchPaymentDetails = async () => {
        try {
            ...
            const res = await axios.get(`http://www.bardagoriyapms.com/api/projects/${projectId}/payment-details/`);
