...
export const useInstallmentDetails = (projectId: number) => {
    ...
    const fetchBanks = async () => {
        try {
            ...
            const res = await axios.get(`http://43.205.255.142/api/settings/bank`);
            setBanks(res.data);
        } catch (err) {
    ...
    const fetchFirst = async () => {
        try {
            setFirstLoading(true);
            const res = await axios.get(`http://43.205.255.142/api/projects/first-installment/${projectId}/`);
    ...
    const fetchSecond = async () => {
        try {
            ...
            const res = await axios.get(`http://43.205.255.142/api/projects/second-installment/${projectId}/`);
    ...
    const fetchThird = async () => {
        try {
            ...
            const res = await axios.get(`http://43.205.255.142/api/projects/third-installment/${projectId}/`);
    ...
    const fetchPaymentDetails = async () => {
        try {
            ...
            const res = await axios.get(`http://43.205.255.142/api/projects/${projectId}/payment-details/`);
