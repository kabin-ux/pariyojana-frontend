  ...
  const fetchData = async () => {
    ...
    try {
      const [wardRes, muniRes, wardThematicRes, prioritizedWardRes, prioritizedWardThematicRes, thematicRes, prioritizedThematicRes, municipalityPrideRes, recommendedThematicWardProjectsRes, thematicBudgetRes, municipalityPrideBudgetRes, wardLevelBudgetRes, municipalityLevelBudgetRes, provincialGovernmentBudgetRes, federalGovernmentBudgetRes, preAssemblyProjectsRes, councilProjectsRes, submittedProjectsRes, approvedProjectsRes] = await Promise.all([
        axios.get('https://www.bardagoriyapms.com/api/planning/ward-office/ward-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/ward-office/municipality-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/ward-office/ward-thematic-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/ward-office/prioritized-ward-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/ward-office/prioritized-ward-thematic/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/thematic/thematic-plans/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/thematic/prioritized-plans/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/municipality-pride-project/municipality-pride-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/thematic/wardrecommend-project/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/thematic-committee/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipality-pride/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/budget-ward-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/municipality-programs/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/provience-transfer-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/budget-committee/federal-gov-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/municipality-executive/pre-assembly-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/municipality-executive/council-submitted-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/municipal-assembly/submitted-projects/'),
        axios.get('https://www.bardagoriyapms.com/api/planning/municipal-assembly/approved-projects/')
      ]);
