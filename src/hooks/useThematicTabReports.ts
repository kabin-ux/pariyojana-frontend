    ...
    const fetchThematicReports = async () => {
        ...
        try {
            const [
                ...
                axios.get('/api/planning/thematic/wardlevel-chart/'),
                axios.get('/api/planning/thematic/wardlevelthemtic-chart/'),
                axios.get('/api/planning/thematic/Wardrecommended-chart/'),

                axios.get('/api/planning/thematic/wardlevel-chart/report/?type=excel'),
                axios.get('/api/planning/thematic/wardlevelthemtic-chart/report/?type=excel'),
                axios.get('/api/planning/thematic/Wardrecommended-chart/report/?type=excel'),

                axios.get('/api/planning/thematic/wardlevel-chart/report/?type=pdf'),
                axios.get('/api/planning/thematic/wardlevelthemtic-chart/report/?type=pdf'),
                axios.get('/api/planning/thematic/Wardrecommended-chart/report/?type=pdf'),
            ]);
    ...
    const downloadFile = async (endpoint: string, type: 'pdf' | 'excel', filename: string) => {
        ...
        try {
            const response = await axios.get(
                `/api/planning/thematic/${endpoint}/report/?type=${type}`,
