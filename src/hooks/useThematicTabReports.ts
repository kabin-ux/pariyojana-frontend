    ...
    const fetchThematicReports = async () => {
        ...
        try {
            const [
                ...
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/wardlevel-chart/'),
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/wardlevelthemtic-chart/'),
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/Wardrecommended-chart/'),

                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/wardlevel-chart/report/?type=excel'),
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/wardlevelthemtic-chart/report/?type=excel'),
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/Wardrecommended-chart/report/?type=excel'),

                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/wardlevel-chart/report/?type=pdf'),
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/wardlevelthemtic-chart/report/?type=pdf'),
                axios.get('http://www.bardagoriyapms.com/api/planning/thematic/Wardrecommended-chart/report/?type=pdf'),
            ]);
    ...
    const downloadFile = async (endpoint: string, type: 'pdf' | 'excel', filename: string) => {
        ...
        try {
            const response = await axios.get(
                `http://www.bardagoriyapms.com/api/planning/thematic/${endpoint}/report/?type=${type}`,
