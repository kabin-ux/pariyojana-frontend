...
const Authentication: React.FC = () => {
  ...
  const fetchAuthenticationDocuments = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`/api/authentication/verification-logs/?all=true`, {
        headers: {
  ...
  const handleCheckDocument = async () => {
    ...
    try {
      const response = await fetch(
        `/api/authentication/documents/${selectedDocument?.source_id}/check/`,
        {
          method: 'PATCH',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleApproveDocument = async () => {
    ...
    try {
      const response = await fetch(
        `/api/authentication/documents/${selectedDocument.source_id}/approve/`,
        {
          method: 'PATCH',
          headers: {
            'Authorization': `Bearer ${token}`,
