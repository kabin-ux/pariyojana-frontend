...
const MunicipalOffice: React.FC = () => {
  const [activeTab, setActiveTab] = useState('नगर सभामा पेश भएँ आफ्नै परियोजना');
  const [searchTerm, setSearchTerm] = useState('');

  const tabs = [
    'नगर सभामा पेश भएँ आफ्नै परियोजना',
  ...
  const municipalData: MunicipalData[] = [
    {
      ...
      costCenter: 'asdfasdfasdfasdfasd',
      budget: '९,००,०००.००',
      wardNo: 'वडा नं.- १',
      status: 'बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस गरेको परियोजना',
      priority: 14
    }
  ];
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <div className="flex items-center space-x-2">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-gray-900 font-medium">नगरकार्यपालिकाको कार्यालय</span>
          </div>
        </div>
