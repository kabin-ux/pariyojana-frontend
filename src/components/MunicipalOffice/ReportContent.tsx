...
export const ReportContent = ({ activeTab }: ReportContentProps) => {
    ...
    switch (activeTab) {
        case 'नगर सभामा पेश गर्नु अघिको परियोजना':
            chartData = preAssemblyChart;
            reportTitle = 'नगर सभामा पेश गर्नु अघिको परियोजना';
            excelLink = preAssemblyReport;
            pdfLink = preAssemblyReportPDF;
            console.log('URLs:', { excelLink, pdfLink });
            break;
        case 'नगर सभा पेश भएका परियोजना':
            chartData = councilChart;
            reportTitle = 'नगर सभामा पेश भएका परियोजना';
            excelLink = councilReport;
            pdfLink = councilReportPDF;
            break;
        default:
            chartData = {};
    }
