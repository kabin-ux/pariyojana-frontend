...
const CityPrideProject: React.FC = () => {
  const [activeTab, setActiveTab] = useState('प्रविधि भएका नगर गौरव आयोजना');
  const [searchTerm, setSearchTerm] = useState('');

  const tabs = [
    'प्रविधि भएका नगर गौरव आयोजना',
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <div className="flex items-center space-x-2">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-gray-900 font-medium">नगर गौरव आयोजना</span>
          </div>
        </div>
...
export default CityPrideProject;