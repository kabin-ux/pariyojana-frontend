...
const BudgetCommittee: React.FC = () => {
  ...
  const handleRecommendWardLevelToPreAssemblyProject = async (id: number) => {
    try {
      await axios.post(`http://43.205.255.142/api/planning/budget-committee/budget-ward-projects/${id}/submit-to-executive/`);
  ...
  const handleRecommendThematicToPreAssemblyProject = async (id: number) => {
    try {
      await axios.post(`http://43.205.255.142/api/planning/budget-committee/thematic-programs/${id}/submit-to-executive/`);
      toast.success('परियोजना सफलतापूर्वक बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस गरियो।');
      window.location.reload();
    } catch (error) {
      console.error(error);
  ...
  const handleRecommendMunicipalityLevelToPreAssemblyProject = async (id: number) => {
    try {
      await axios.post(`http://43.205.255.142/api/planning/budget-committee/municipality-programs/${id}/submit-to-executive/`);
      toast.success('परियोजना सफलतापूर्वक बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस गरियो।');
      window.location.reload();
    } catch (error) {
      console.error(error);
  ...
  const handleRecommendMunicipalityPrideToPreAssemblyProject = async (id: number) => {
    try {
      await axios.post(`http://43.205.255.142/api/planning/budget-committee/municipality-pride/${id}/submit-to-executive/`);
      toast.success('परियोजना सफलतापूर्वक बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस गरियो।');
      window.location.reload();
    } catch (error) {
      console.error(error);
  ...
  const handleRecommendProvincialGovernmentToPreAssemblyProject = async (id: number) => {
    try {
      await axios.post(`http://43.205.255.142/api/planning/budget-committee/provience-transfer-projects/${id}/submit-to-executive/`);
      toast.success('परियोजना सफलतापूर्वक बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस गरियो।');
      window.location.reload();
    } catch (error) {
      console.error(error);
  ...
  const handleRecommendFederalGovernmentToPreAssemblyProject = async (id: number) => {
    try {
      await axios.post(`http://43.205.255.142/api/planning/budget-committee/federal-gov-projects/${id}/submit-to-executive/`);
      toast.success('परियोजना सफलतापूर्वक बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस गरियो।');
      window.location.reload();
    } catch (error) {
      console.error(error);
