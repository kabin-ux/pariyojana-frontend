    ...
    const fetchDashboardData = async () => {
      ...
      try {
        const [summaryRes, budgetRes, areaRes, wardRes, budgetAreaRes] = await Promise.all([
          ...
          axios.get('/api/dashboard/budget-summary/', {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get('/api/dashboard/area-wise-distribution/', {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get('/api/dashboard/wardwise-budget/', {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get('/api/dashboard/budget-area/', {
            headers: { Authorization: `Bearer ${token}` },
          }),
        ]);
