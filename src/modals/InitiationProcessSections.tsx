...
const InitiationProcessSection: React.FC<InitiationProcessSectionProps> = ({ projectId }) => {
    ...
    const fetchInitiationProcess = async () => {
        setLoading(true);
        try {
            const res = await axios.get(`http://213.199.53.33/api/projects/${projectId}/initiation-process/`);
    ...
    const handleFinalConfirm = async () => {
        ...
        try {
            await axios.post(`http://213.199.53.33/api/projects/${projectId}/initiation-process/`, {
                project: projectId,
