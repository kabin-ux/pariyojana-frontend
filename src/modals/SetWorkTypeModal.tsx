...
const WorkTypeModal: React.FC<CostEstimateModalProps> = ({
    isOpen,
    onClose,
    workTypeData,
    onSave,
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const url = hasId
                ? `http://213.199.53.33:8000/api/projects/${projectId}/work-types/${formData.id}/`
                : `http://213.199.53.33:8000/api/projects/${projectId}/work-types/`;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                            एकाइ <span className="text-red-500">*</span>
                        </label>
                        <select
                            required
                            value={formData.unit}
